...
# Deployment identity (all overridable via env; defaults keep the live setup).
PKG = os.environ.get("MOSS_ANDROID_PACKAGE", "com.example.moss")
HOST = os.environ.get("MOSS_ANDROID_HOST", "moss.example.com")
KEYSTORE_DN = os.environ.get("MOSS_KEYSTORE_DN", "CN=Moss, OU=Moss, O=Moss")
...
<resources>
    ...
    <string name="launchUrl">https://{HOST}/</string>
    <string name="hostName">{HOST}</string>
    <string name="webManifestUrl">https://{HOST}/manifest.webmanifest</string>
