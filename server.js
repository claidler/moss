...
// sse.js (SSE/chunk helpers) · notes.js (+ notes-text/store/enrich) · uploads.js · transcribe.js
...
http
  ...
  .listen(PORT, HOST, () => {
    ...
    goals.init({ gatewayRpc: gateway.gatewayRpc });
    reconcile.init({ gatewayRpc: gateway.gatewayRpc });
